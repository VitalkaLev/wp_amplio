    ...
    <div class="credit__wrapper">
        <div class="credit__inner">
            <div class="credit__left">
                <h2>
                    Розрахуйте та подайте заявку на отримання кредиту
                </h2>
                <form action="/" class="credit__form animate-fade" data-delay="0.7s">
            ...
            <div class="credit__right">
                <div class="credit__box">
                    <div class="credit__text__item animate-fade" data-delay="0.4s">
                        <div class="credit__text__icon">
                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="60" height="60" rx="16" fill="#2046D2"/>
                                <g clip-path="url(#clip0_888_12)">
                                <path d="M39 24H23C22.141 24 21.328 23.628 20.765 23.001C21.315 22.387 22.114 22 23 22H41C42.308 21.994 42.307 20.005 41 20H23C20.239 20 18 22.239 18 25V35C18 37.761 20.239 40 23 40H39C40.657 40 42 38.657 42 37V27C42 25.343 40.657 24 39 24ZM38 33C36.692 32.994 36.692 31.006 38 31C39.308 31.006 39.308 32.994 38 33Z" fill="white"/>
                                </g>
                                <defs>
                        ...
                        <div class="credit__text__content">
                            ...
                            <span class="final-amount-month">
                                27 000 грн
                            </span>
                        </div>
                    </div>
                    <button id="creditSubmit" class="btn btn-primary h-bg h-full green animate-fade" data-delay="0.5s">
                    ...
                    <span class="credit__text__note animate-fade" data-delay="0.7s">
                        Ці розрахунки є орієнтовними
                    </span>
                </div>
        ...
        <div class="credit__result">
            <div class="credit__result__content">
                <svg width="241" height="240" viewBox="0 0 241 240" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="120.245" cy="120" r="120" fill="#98E48A"/>
                    <path d="M189.245 103.416C172.748 122.295 156.456 139.127 126.484 144.821C109.875 147.976 93.7227 144.436 80.65 138.498C67.7034 132.616 56.9332 123.995 51.2449 115.873L64.1547 106.79C67.8434 112.057 76.1065 119.077 87.1612 124.098C98.0899 129.063 110.907 131.69 123.547 129.288C147.973 124.648 161.25 111.458 177.38 93L189.245 103.416Z" fill="white"/>
                </svg>
                <h2>
                    <b>Вітаємо!</b> Кредит для ФОП від Amplio зараховано.
                </h2>
            </div>
            <div class="credit__result__decor">
