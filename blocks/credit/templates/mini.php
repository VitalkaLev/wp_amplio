<?php
$title = get_field('acf_credit_mini_title');
$sum = get_field('acf_credit_mini_sum');
$term = get_field('acf_credit_mini_term');
$month = get_field('acf_credit_mini_mounth');
$text = get_field('acf_credit_mini_text');
$button = get_field('acf_credit_mini_button');
...
if( isset( $block['data']['preview_image_help'] )) {
    ...
    <div id="credit" class="section credit credit-mini animate-fade" data-delay="0.3s">
        <div class="credit__wrapper">
            <div class="credit__inner">
                <div class="credit__left">
                    <?php if (!empty($title)) { ?>
                        <h4><?php echo theme_text($title); ?></h4>
                    <?php } else { ?>
                    ...
                    <form method="POST" action="<?php theme_home_url(); ?>/online/" class="credit__form animate-fade" data-delay="0.7s">
                        <div class="credit__form__inner">
                            <div class="credit__form__row">
                                ...
                                <span class="credit__form__group hidden">
                                    <span>1000 грн</span>
                            ...
                            <div class="credit__form__row">
                                ...
                                <span class="credit__form__group term__buttons hidden">
                    ...
                    <div class="credit__box">
                        <div class="credit__text__item animate-fade" data-delay="0.4s">
                            ...
                            <div class="credit__text__content">
                                ...
                                <?php } ?>
                                <span class="final-amount-month">3563.44 грн/міс</span>
                            </div>
                        </div>
                        <?php if (!empty($button)) : ?>
